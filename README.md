...
Technology
Backend
PHP (server-side logic, session handling, form processing)
Database
MySQL (bookworld.sql schema — users, products, orders)
Core Frontend
HTML5, custom CSS, Tailwind CSS
Analytics Module
